...
#     usefullness = [f'{num}. {" ".join(line.split())} - {len(line.split())} слов ' for num, line in enumerate]
...
#     print(f'Average salary = {round(sum(employees_dict.values()) / len(employees_dict), 4)}\n'
